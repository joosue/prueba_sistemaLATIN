...
<body>
    ...
    <form id="combo" name="combo" action="guarda.php" method="POST">
        ...
        <center>
            <div class="container ">
                ...
                <div class="row">
                    <div class=" input-group  input-group-lg align-self-center  col-md-10   border border-dark">
                        <h2><b>TOP LATINO TV:</b>Hoja de Datos para Operadores de Cable</h2>
                    </div>
                    <div class="col-md-10  input-group-lg  align-self-center border border-dark bg-warning text-black">
                    ...
                    <div class="col-md-10  input-group-lg  align-self-center border border-dark bg-info text-white">
                        <h4><b>INFORMACION GENERAL</b></h4>
                    </div>
    ...
    $(function () {
        ...
        $("#cbx_departamento").change(function () {
            ...
            $('#cbx_distrito option').not('option[value=0]').remove();

            $("#cbx_departamento option:selected").each(function () {
                const idDepa = this.value;
                $.post("./includes/getProvincia.php", {
                    idDepa: idDepa
                }, function (data) {
